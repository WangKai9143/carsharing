...
Page({
  ...
  getList: function () {
    var that = this;
    util.get('dynamic/getList', { page: page, sk: app.globalData.sk }, function (data) {
      var list = data.list;
      if (page == 1) {
        var arr = new Array();
      } else {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          ...
          util.get('dynamic/del',{id:id,sk:app.globalData.sk},function(data){
            if(data.status == '1'){
